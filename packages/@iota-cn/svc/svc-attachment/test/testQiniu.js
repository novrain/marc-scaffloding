...
describe('attchment test >', function () {
    this.timeout(10000);
    config.port = 3337;
    config.mws[3].opts.qiniu = {
        bucket: 'fssv',
        accessKey: '5lGsNzTojbsfzh1NDyf5xI-njt5PQHBJPmllH3B0',
        secretKey: 'uPhJ60RSIanBsPhws3LjbGTVb4CQuyjcCEnXYbB4',
        domain: 'http://7xofce.com1.z0.glb.clouddn.com'
    }
