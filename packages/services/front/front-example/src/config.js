...
module.exports = {
    plugins: [
        {
            plugin: require('@iota-cn/ui-scaffolding/src/framework/root'), opts: {}
        },
        {
            plugin: require('@iota-cn/ui-scaffolding/src/framework/layout-container'), opts: {
        ...
        {
            plugin: require('@iota-cn/ui-scaffolding/src/framework/general-pages'), opts: { // 404 等
                parents: [
        ...
        {
            plugin: require('@iota-cn/ui-scaffolding/src/plugins/base/menu'), opts: {
                id: 'menu', // 实例id
                containerId: COMPLEX_CONTAINER_ID
            }
        },
        {
            plugin: require('@iota-cn/ui-scaffolding/src/plugins/base/authentication'), opts: {
                signin: {
                    redirect: '/console'
                }
            }
